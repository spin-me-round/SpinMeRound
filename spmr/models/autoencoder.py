...
class AutoencodingEngineLegacy(AutoencodingEngine):
    def __init__(self, embed_dim: int, **kwargs):
        ...
        super().__init__(
            encoder_config={
                "target": "spmr.modules.diffusionmodules.model.Encoder",
                "params": ddconfig,
            },
            decoder_config={
                "target": "spmr.modules.diffusionmodules.model.Decoder",
                "params": ddconfig,
            },
            **kwargs,
        )
...
class AutoencoderKL(AutoencodingEngineLegacy):
    def __init__(self, **kwargs):
        ...
        super().__init__(
            regularizer_config={
                "target": (
                    "spmr.modules.autoencoding.regularizers"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            regularizer_config={
                "target": (
                    "spmr.modules.autoencoding.regularizers.quantize" ".VectorQuantizer"
                ),
                "params": {
                    "n_e": n_embed,
                    "e_dim": embed_dim,
